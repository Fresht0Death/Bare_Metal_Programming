...
#define DMA1EN       (1U<<21) // how do you enable dma1?
#define DMA_S_EN     (1U<<0)  // how do you enable the dma status?
#define CHSEL4       (1U<<27) // how do you channel select 4?
#define DMA_MEM_INC  (1U<<10) // where do you look for memory inc?
#define DMA_DIR_MEM_TO_PERIPH   (1U<<6) // how do put direct memory to peripheral?
#define DMA_CR_TCIE  (1U<<4) // hwo do you turn on tcie control register?
#define DMA_CR_EN    (1U<<0)  // how do you enable dma?
#define UART_CR3_DMAT (1U<<7) // how do you turn on uart cr3 dmat
#define DMA_HIFCR_CTCIF6_ME     (1U<<21) // not sure what this one is?
...
/* dma stream 6 init function */
/* 3 parameters: 32 bit source, destination, and length */
void dma1_stream6_init(uint32_t src, uint32_t dst, uint32_t len)
{
	...
	DMA1_Stream6->PAR = dst; // this was confusing

	/* Set the source buffer */
	DMA1_Stream6->M0AR = src; // this I have no idea about
	...
	/* Enable memeory increment */
		// look at control register to check which one
